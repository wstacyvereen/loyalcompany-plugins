		...
		CircleProgress : function( $scope, $ ) {
			...
			ee.CircleProgress.init = function() {
				...
				if ( ! elementSettings.animate ) {
					...
					$value.text( ee.CircleProgress.getStepValue( cpArgs.value ) );
			...
			ee.CircleProgress.onProgress = function( event, progress, stepValue ) {
				$value.text( ee.CircleProgress.getStepValue( stepValue ) );
			};

			ee.CircleProgress.getStepValue = function( stepValue ) {
